...
public class TestController {
	...
	public void deleteTest(@RequestBody TestData testData) {
		//TODO
		String strToDelete = TestData.getMessage();
		delete(strToDelete);
		System.out.println("Hello, %s! You sent a delete request with a requestbody!");
	}
	
	@PutMapping("/putTest")
	public void putTest(@RequestBody String newMessage) {
		//TODO
		String oldMessage = TestData.getMessage();
		oldMessage = newMessage;
		System.out.println("Hello, %s! You sent a delete request");
	}
}
